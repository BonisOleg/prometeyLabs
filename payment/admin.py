...
class PaymentSettingsAdmin(admin.ModelAdmin):
    """Адмін для глобальних налаштувань платіжної системи"""
    
    fieldsets = (
        ("Договір", {
            'fields': ('default_contract_file', 'contract_title', 'contract_description'),
            'description': 'Налаштування договору, який буде автоматично доступний на всіх сторінках оплати'
        }),
        ("Системна інформація", {
    ...
    def has_add_permission(self, request):
        # Дозволяємо створення тільки якщо немає записів
    ...
    def changelist_view(self, request, extra_context=None):
        # Автоматично створюємо запис якщо його немає
