...
class PaymentSettings(models.Model):
    """Глобальні налаштування для платіжної системи"""
    
    # Завжди буде тільки один запис
    id = models.AutoField(primary_key=True)
    
    # Договір, який буде доступний для всіх платежів
    default_contract_file = models.FileField(
        upload_to='contracts/default/', 
        verbose_name="Договір за замовчуванням (PDF)", 
        blank=True, 
        null=True,
        help_text="Цей договір буде автоматично доступний на всіх сторінках оплати"
    )
    
    # Інші глобальні налаштування можна додати тут
    contract_title = models.CharField(
        max_length=255,
        verbose_name="Назва договору",
        default="Публічний договір",
        help_text="Назва, яка буде відображатися біля посилання на договір"
    )
    
    contract_description = models.TextField(
        verbose_name="Опис договору",
        default="Усі послуги надаються відповідно до публічного договору, який доступний для ознайомлення на сторінці перед оплатою. Оплата є підтвердженням вашої згоди з умовами договору.",
        help_text="Текст, який буде відображатися біля посилання на договір"
    )
    ...
    def __str__(self):
        return "Налаштування платіжної системи"
    
    @classmethod
    def get_settings(cls):
        """Отримує або створює єдиний екземпляр налаштувань"""
    ...
    def delete(self, *args, **kwargs):
        # Забороняємо видалення налаштувань
        pass
